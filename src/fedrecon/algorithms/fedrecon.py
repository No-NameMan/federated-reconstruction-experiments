...
from fedrecon.algorithms.aggregation import apply_delta_to_state, weighted_average_deltas
...
def run_fedrecon_round(
    ...
    *,
    ...
    new_state = apply_delta_to_state(model.clone_global_state(), avg_delta, server_lr=server_lr)
